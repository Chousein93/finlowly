  ...
  return (
    <div className="p-4 sm:p-8 space-y-6 sm:space-y-8 animate-in fade-in duration-500 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-1.5">
                  <div className="h-3.5 w-3.5 rounded-full bg-slate-100 flex items-center justify-center">
                    <TrendingUp className="h-2 w-2 text-slate-400" />
                  </div>
        ...
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 bg-white group">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-slate-400 uppercase">Ödenen</span>
                <span className="text-sm font-bold text-slate-900">₺0</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-slate-400 uppercase">Kalan</span>
                <span className="text-sm font-bold text-slate-900">₺0</span>
              </div>
            </div>
        ...
        {/* 3. Category Distribution Placeholder */}
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 bg-white group">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
        ...
        {/* 4. Cash Flow Forecast Placeholder */}
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 bg-white group">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-semibold text-slate-600 uppercase tracking-wider">Gelecek 3 Ay Tahmini</CardTitle>
            <TrendingUp className="h-4 w-4 text-slate-400 group-hover:text-slate-900 transition-colors" />
          </CardHeader>
          <CardContent>
            <div className="h-20 w-full rounded-lg border border-dashed border-slate-200 bg-slate-50/50 flex flex-col items-center justify-center p-4">
              ...
              <p className="text-[10px] text-slate-400 text-center font-medium">Veri yok - Tekrarlayan ödemeler ekleyin.</p>
            </div>
          </CardContent>
        </Card>
      </div>
